...
namespace object2D
{
    ...
    Mesh* CreateHex(const std::string& name, glm::vec3 leftBottomCorner, float length, glm::vec3 color2, bool fill = false);
    ...
    Mesh* CreateRhombus(const std::string& name, glm::vec3 leftBottomCorner, float length, glm::vec3 color, bool fill = false);
